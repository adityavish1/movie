...
const HomeScreen = () => {
	...
	// if(trendingContent.results.length === 0) return null;
	...
	return (
		<>
			...
			{trendingContent?.results?.length === 0 ? null : (
					<img
						src={trendingContent?.results?.banner} // Assuming banner is an array item
						alt='Hero img'
				...
				<div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
					...
					<div className='flex mt-8'>
						<Link
							to={`/watch/${trendingContent?.results?.imdb_id}`}
